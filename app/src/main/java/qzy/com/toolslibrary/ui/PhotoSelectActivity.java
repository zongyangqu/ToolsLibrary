...
public class PhotoSelectActivity extends BaseActivity  implements View.OnClickListener,
    ...
    protected void onViewCreated() {
        ...
        adapter = new GridImageAdapter(PhotoSelectActivity.this, onAddPicClickListener);
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(PhotoSelectActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(PhotoSelectActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(PhotoSelectActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
...
//                        .videoMinSecond(10)
                ...
                PictureSelector.create(PhotoSelectActivity.this)
                        ...
                        .videoMinSecond(10)////显示多少秒以内的视频or音频也可适用
                        .videoMaxSecond(19)// 显示多少秒以内的视频or音频也可适用 int
                        .recordVideoSecond(11)//视频秒数录制 默认60s int
                        .forResult(PictureConfig.CHOOSE_REQUEST);//结果回调onActivityResult code
            }
        }
    };
                ...
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    for (LocalMedia media : selectList) {
                        ...
                        if (media.isCompressed()){
                            Log.i("getCompressPath-----》", media.getCompressPath());
                        }
                    }
                    adapter.setList(selectList);
